...
To build the final jar and optimize the AbsaGatewayService application for production, run:
...
Then navigate to [http://localhost:9044](http://localhost:9044) in your browser.
